  ...
  return (
    <div className={classes.card}>
      <div className={classes.center}>
        ...
        <p>
          En prenant part a notre evenement , vous associez votre entreprise a
          une operation de communivation ciblée et efficace. En effet,votre
          entreprise bénéficiera d'une visibilité non seulement lors de la
          médiatisation de l'évenement mais aussi le jour meme de l'évènement.
        </p>
